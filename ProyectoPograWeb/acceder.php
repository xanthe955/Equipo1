    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="/ProyectoPograWeb/procesar_acceso.php"> <!-- Cambio de acción del formulario -->
                        ...
                        <div class="form-group">
                            <button type="submit" name="loginForm" class="btn btn-primary">Acceder</button>
                        </div>
                    </form>
                </div>
            </div>
